...
-- V4a 21.06.2023 R-XSR receiver added
...
local function changeSetup()
  ...
  elseif SelectedItem == 5 then
    if t == 0 or t == 3 or t == 5 or t == 7 then  --D8R/D4R or RX8R-PRO Receivers or RX4R/6R or R-XSR
      InvSbusRead = 0
...
local function refreshSetup()
  ...
  if InvSbusRead == 1 then
    if t == 0 then --D8R/D4R Receiver
      ...
      skipItem = 0
    elseif t == 3 or t == 5 or t == 7 then --RX8R-PRO Receiver or RX4R/6R or R-XSR
