...
{"Paketverluste",		 		"Total dropped pkts"		}, --13
{"CRC Fehler", 					"CRC Errors"				}, --14
{"Verluste (%)",				"Drop Percent"				}, --15
{"Laufzeit (Ds)",				"Ave Packet time"			}, --16
{"Tele Resets",					"Telemetry resets"			}, --17
{"Antennenwechsel",				"Antenna swaps"				}, --18
{"Tele-aussetzer",				"Telemetry not sent (times)"}, --19
{"Software Vers.", 				"Software Rev"				}, --20
{"Rx Protokoll", 				"Rx Protocol"				}, --21
{"Rx Typ", 						"Rx Type"					}, --22
{"Antenne0 (OK)", 				"Antenna count[0]"			}, --23
{"Antenne1 (OK)", 				"Antenna count[1]"			}, --24
